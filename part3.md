...
- Intrusion detection system (IDS) / Intrusion prevention system (IPS)
  ...
  + 🧅 **[Security Onion](https://github.com/Security-Onion-Solutions/securityonion/blob/master/VERIFY_ISO.md)**, open-source Linux-based platform for security monitoring, incident response and threat hunting (bundles Snort, Suricata, Zeek, Wireshark, and NetworkMiner)
